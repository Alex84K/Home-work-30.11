...
public class SaveEmployeAppl {
    public static void main(String[] args) {
        ...
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("amployees.dat"))) {
            oos.writeObject(employees); //сериализация
